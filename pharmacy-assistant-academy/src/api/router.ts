...
export class ApiRouter {
    ...
    addRoute(method: string, path: string, handler: RouteHandler, middlewares: Middleware[] = []): void {
        this.routes.push({
    ...
    private async executeMiddlewares(
        ...
        return await currentMiddleware(req, async () => {
    ...
    async handleRequest(req: ApiRequest): Promise<ApiResponse> {
        ...
        const allMiddlewares = [...this.globalMiddlewares, ...match.route.middlewares]
