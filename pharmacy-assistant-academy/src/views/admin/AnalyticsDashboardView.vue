...
async function loadLearningStats() {
  ...
  try {
    ...
    const response = await api.get('/api/v1/analytics/learning-stats', { params })
    if (response.data.success) {
...
async function loadJobMatchingStats() {
  ...
  try {
    ...
    const response = await api.get('/api/v1/analytics/job-matching-stats', { params })
    if (response.data.success) {
...
async function loadSatisfactionStats() {
  ...
  try {
    ...
    const response = await api.get('/api/v1/analytics/course-satisfaction-stats', { params })
    if (response.data.success) {
