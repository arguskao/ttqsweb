              ...
              <div class="column">
                <div class="level">
                  <div class="level-left">
                    <div>
                      <p class="title is-5">{{ application.first_name }} {{ application.last_name }}</p>
                  ...
                  <div class="level-right">
                    <div class="tags">
                      ...
                      <span v-if="!application.is_active" class="tag is-medium is-dark">已停用</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="content">
                  <div class="columns">
                    <div class="column">
                      ...
                      <p><strong>工作年資：</strong>{{ application.years_of_experience || 0 }} 年</p>
                    </div>
                    <div class="column">
                      <p><strong>平均評分：</strong>{{ (application.average_rating || 0).toFixed(1) }}/5.0 ({{ application.total_ratings || 0 }} 評價)</p>
...
const reviewApplication = async (instructorId: number, status: 'approved' | 'rejected') => {
  ...
  try {
    ...
    await api.post(`/api/v1/instructors/${instructorId}/review`, { status })
