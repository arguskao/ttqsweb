              ...
              <div class="card">
                <div class="card-content has-text-centered">
                  <figure class="image is-128x128 is-inline-block mb-4">
                    <div class="has-background-primary has-text-white is-flex is-align-items-center is-justify-content-center" style="width: 128px; height: 128px; border-radius: 50%; font-size: 48px; font-weight: bold;">
              ...
              <div class="card mt-4">
                ...
                <div class="card-content">
                  ...
                  <div class="field">
                    ...
                    <p class="is-size-4">{{ ((instructor.average_rating || 0) * 20).toFixed(0) }}/100</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <div v-else>
                    ...
                    <nav v-if="ratingsMeta.totalPages > 1" class="pagination is-centered mt-4" role="navigation">
                      <button 
...
const loadInstructor = async () => {
  try {
    ...
    const response = await api.get(`/api/v1/instructors/${instructorId}`)
...
const loadStats = async () => {
  ...
  try {
    const response = await api.get(`/api/v1/instructors/${instructor.value.id}/stats`)
...
const loadRatings = async () => {
  ...
  try {
    ...
    const response = await api.get(`/api/v1/instructors/${instructor.value.id}/ratings`, {
      params: {
    ...
    if (response.meta) {
      ratingsMeta.value = response.meta
    }
  } catch (error) {
